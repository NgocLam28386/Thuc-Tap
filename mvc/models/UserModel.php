...
class userModel
{
    ...
    public function insert($fullName, $email, $dob, $address, $password, $provinceId, $districtId, $wardId)
    {
        ...
        if ($result) {
            ...
            $mail->SetFrom("khuongip564gb@gmail.com", "Fashion STORE");
            $mail->Subject = "Xác nhận email tài khoản - Fashion STORE";
            $mail->Body = "<h3>Cảm ơn bạn đã đăng ký tài khoản tại website Fashion STORE</h3></br>Đây là mã xác minh tài khoản của bạn: " . $captcha . "";
